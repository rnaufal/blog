...
/**
 * Created by Rafael Naufal on 10/05/2019.
 */
class ImperativeCharSummarizerTest {

    private CharSummarizer imperativeCharSummarizer;

    @BeforeEach
    void setUp() {
        imperativeCharSummarizer = new ImperativeCharSummarizer();
    }
    ...
    void shouldSummarizeCharsSuccessfully(final ArgumentsAccessor arguments) {
        var charSummaryStatistics = imperativeCharSummarizer.summarize(arguments.getString(0));
