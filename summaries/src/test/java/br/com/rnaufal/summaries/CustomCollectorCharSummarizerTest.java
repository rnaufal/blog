 ...
 */
class CustomCollectorCharSummarizerTest {

    private CharSummarizer customCollectorCharSummarizer;

    @BeforeEach
    void setUp() {
        customCollectorCharSummarizer = new CustomCollectorCharSummarizer();
    }
    ...
    void shouldSummarizeCharsSuccessfully(final ArgumentsAccessor arguments) {
        var charSummaryStatistics = customCollectorCharSummarizer.summarize(arguments.getString(0));
